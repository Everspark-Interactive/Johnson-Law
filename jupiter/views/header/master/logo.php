...
if (!empty($logo) || !empty($sticky_logo)) {
    ...
    ?>
	    ...
	    <a href="<?php echo home_url('/'); ?>" title="<?php esc_attr( bloginfo('name') ); ?>">
			             ...
			             <img class="mk-desktop-logo dark-logo" title="<?php esc_attr( bloginfo('description') ); ?>" alt="Lake Charles Attorneys" src="<?php echo esc_url( $logo ); ?>" />
			    
			    <?php if ($light_logo) { ?>
			             <img class="mk-desktop-logo light-logo" title="<?php esc_attr( bloginfo('description') ); ?>" alt="Lake Charles Attorneys" src="<?php echo esc_url( $light_logo ); ?>" />
			    <?php } ?>
			    
			    <?php if ($mobile_logo && !$is_nav_item) { ?>
			             <img class="mk-resposnive-logo" title="<?php esc_attr( bloginfo('description') ); ?>" alt="Lake Charles Attorneys" src="<?php echo esc_url( $mobile_logo ); ?>" />
			    <?php } ?>
			    
			    <?php if ($sticky_logo) { ?>
			             <img class="mk-sticky-logo" title="<?php esc_attr( bloginfo('description') ); ?>" alt="Lake Charles Attorneys" src="<?php echo esc_url( $sticky_logo ); ?>" />
			    <?php } ?>
	    </a>
    </<?php echo $tag; ?>>
<?php } else { ?>
