...
if (!function_exists('mk_employees_meta_information')) {
    function mk_employees_meta_information()
    {
        ...
        $output = '<span class="employees_meta"><span class="team-member team-member-name s_meta a_align-center a_display-block a_margin-top-40 a_font-weight-bold a_color-333 a_font-22"><h1 style="font-size:28px;">'.get_the_title().'</h1></span>';
