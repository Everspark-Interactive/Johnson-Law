...
<footer id="mk_page_footer">
    ...
    <div class="mk-header-top" id="headertopbar">
        <span class="header-toolbar-top">
            <a href="tel:+13372940203">337-294-0203</a>
        </span>
    </div>
    <?php
...
<?php //if(!wp_is_mobile()){ ?>
    ...
    <script type="text/javascript">
	   ...
	   <script type="text/javascript">
        jQuery('.review-slider > div').slick({
          infinite: true,
          slidesToShow: 3,
          slidesToScroll: 3,
          responsive: [
...
<script type="text/javascript">
jQuery( document ).ready(function() {
        setTimeout(equlhg, 3000);
    function equlhg(){    
    var heights=[];
    jQuery('#recentnews .vc_col-sm-4').each(function(){
    heights.push(jQuery(this).height());
    });
    var maxhg=Math.max.apply(null,heights);
    jQuery('#recentnews .vc_col-sm-4').height(maxhg);
    var heights1=[];
    jQuery('#recentnews .vc_gitem-animated-block').each(function(){
    heights1.push(jQuery(this).height());
    });
    var maxhg1=Math.max.apply(null,heights1);
    jQuery('#recentnews .vc_gitem-animated-block').height(maxhg1); 
    var heights2=[];
    jQuery('#recentnews .vc_gitem-zone.vc_gitem-zone-c').each(function(){
    heights2.push(jQuery(this).height());
    });
    var maxhg2=Math.max.apply(null,heights2);
    jQuery('#recentnews .vc_gitem-zone.vc_gitem-zone-c').height(maxhg2); 
    var heights3=[];
    jQuery('#recentnews .vc_gitem-zone.vc_gitem-zone-c h4').each(function(){
    heights3.push(jQuery(this).height());
    });
    var maxhg3=Math.max.apply(null,heights3);
    jQuery('#recentnews .vc_gitem-zone.vc_gitem-zone-c h4').height(maxhg3); 
    }
});</script>
<?php } ?>
...
jQuery(".addnlcost-old").keyup(function() {
      var cc=0;
      var cd=0;
      var gross_in=0;
      cc =jQuery(this).val();
...
function clearfield(){
	...
	jQuery("#sub-footer .right").html('<span> © 2023, The Johnson Firm. All rights reserved. </span> <a style="color:#fff;" href="https://johnsonfirmla.com/privacy-policy/"> Privacy Policy </a>');
</script>
</footer>  
</body>
</html>