...
function get_product_info() {
	...
	$new_theme_response = get_transient( 'genesis_block_theme_product_info' );

	if ( false !== $new_theme_response ) {
	...
	$new_theme_response = wp_remote_get( 'https://wp-product-info.wpesvc.net/v1/plugins/genesis-block-theme', $request_args );
	...
	$new_theme_response->url         = 'https://www.studiopress.com/genesis-block-theme/';
