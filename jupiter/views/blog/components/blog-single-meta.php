...
<div class="blog-single-meta">
	<div class="mk-blog-author" itemtype="http://schema.org/Person" itemprop="author"><?php esc_html_e( 'By', 'mk_framework' ); ?> <?php if ( 'news-article' == get_post_type() ){ ?> <span class="news-author"> <?php echo get_field('author');?> </span> <?php } else { esc_url( the_author_posts_link() );} ?> </div>
