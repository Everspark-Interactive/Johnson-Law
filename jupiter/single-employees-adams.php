...
.video-thumbb1:before {
    content: '';
    background: url(https://johnsonfirmdev.wpengine.com/wp-content/uploads/2022/05/hero-video-thumbnail-bg.jpg);
    position: absolute;
    width: 470px;
    height: 250px;
    margin-top: 27px;
...
.bgimg1:before {
    content: '';
    background: url(https://johnsonfirmdev.wpengine.com/wp-content/uploads/2022/05/bg-profile.png);
    position: absolute;
    width: 275px;
    height: 275px;
    margin-top: 25px;
...
.txt-right:before {
    content: url(https://johnsonfirmdev.wpengine.com/wp-content/uploads/2022/05/quote-erin.png);
    position: relative;
}
.txt-right p {
    color: #195775;
...
#theme-page .theme-page-wrapper .theme-content {
    ...
    background: url(https://johnsonfirmdev.wpengine.com/wp-content/uploads/2022/05/bg-pilar.jpg) no-repeat top;
...
.theme-content1 {
    ...
    background: url(https://johnsonfirmdev.wpengine.com/wp-content/uploads/2022/05/formbg.png) no-repeat top;
...
<div id="theme-page" class="master-holder  clearfix" itemscope="itemscope" itemtype="https://schema.org/Blog">
        ...
        <div class="contactinfo">
          ...
          <span><a href="mailto:<?php the_field('email'); ?>"><img src="https://johnsonfirmdev.wpengine.com/wp-content/uploads/2022/05/mails1.png"></a></span>
          <span><a href="tel:<?php the_field('mobile'); ?>"><img src="https://johnsonfirmdev.wpengine.com/wp-content/uploads/2022/05/calls1.png"></a></span>
        </span>
      ...
      <!-- Accordion END -->
        ...
        <div class="single-employee-content pillar">
          ...
          <div class="videos">
            <div class="vids-left">
              ...
              <p> <video class="banner-video" controls="controls" width="300" height="150"><source src="/wp-content/uploads/2022/05/banner-video.mp4" type="video/mp4"></video></p>
              <div class="clearboth"></div>
            </div>
            </div>
            <div class="txt-right">
        ...
        <div class="single-employee-sidebar a_display-inline-block a_float-left">
          ...
          <img src="https://johnsonfirmdev.wpengine.com/wp-content/uploads/2022/05/johson-logo.png">
        ...
        <div class="single-employee-content">
          <div class="forms">
            <h2 class="con">Shedule a Consultation</h2>
